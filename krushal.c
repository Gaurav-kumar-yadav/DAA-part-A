...
/* Sample output
Enter the number of vertices : 6 Enter the number of edges : 10 Enter the edge list(u v cost) 0 1 3 1 2 1 2 3 6 3 4 8 4 0 6 0 5 5 1 5 4 2 5 4 3 5 5 4 5 2 Spanning tree exists
    The spanning tree is as follows : 0 1 1 2 15 35 4 5 The cost of the spanning tree is
    16 The time taken is 0.655643*/